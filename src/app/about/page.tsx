...
<AboutImg/>
     <div className="flex flex-col pl-5">
      ...
      <a className=" underline underline-offset-1 pl-6" href="https://vietcetera.com/vn/khim-dang-loi-the-lon-nhat-cua-nghe-si-viet-nam-la-can-tinh-viet">Viet Cetera</a>
    ...
    <div  className="flex flex-col pl-5 pb-5">
      ...
      <a className=" underline underline-offset-1 pl-6" href="instagram.com/khimdangoff">{"@khimdangoff"}</a>
    </div>
      </div>
    </section>
  );
